...
import src.raft_pb2 as raft__pb2
...
class RaftServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ClientRequest = channel.unary_unary(
                ...
                request_serializer=raft__pb2.ClientOpRequest.SerializeToString,
                response_deserializer=raft__pb2.ClientOpResponse.FromString,
                _registered_method=True)
...
def add_RaftServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ClientRequest': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=raft__pb2.ClientOpRequest.FromString,
                    response_serializer=raft__pb2.ClientOpResponse.SerializeToString,
            ),
    }
...
class RaftService(object):
    ...
    def ClientRequest(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/raft.RaftService/ClientRequest',
            raft__pb2.ClientOpRequest.SerializeToString,
            raft__pb2.ClientOpResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
